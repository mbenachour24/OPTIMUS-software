...
class CitizenPressure:
    ...
    def generate_daily_cases(self):
        ...
        """
        generated_cases = []
        valid_norms = self.political_system.get_valid_norms()
